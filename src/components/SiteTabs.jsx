...
export default function SiteTabs({ activeSite, onSelect }) {
  return (
    <nav
      ...
      aria-label="거점 선택"
    >
      <div className="calendar-scroll flex gap-1 overflow-x-auto px-2 py-2 sm:px-4">
          ...
          {SITE_TABS.map((site) => {
            ...
            return (
              <button
                ...
                className={`touch-manipulation whitespace-nowrap rounded-full px-3.5 py-2 text-sm font-semibold transition active:opacity-90 sm:px-4 ${
                  selected
